...
public class PorcentajePodios extends Estadistica {
    ...
    private static final Integer PONDERACION_PORCENTAJE_PODIOS = 10;
    private static final Integer COSTO_PORCENTAJE_PODIOS = 9;

    public PorcentajePodios(){
        super(PONDERACION_PORCENTAJE_PODIOS,COSTO_PORCENTAJE_PODIOS);
    }

    private static final Double LIMITE_SUPERIOR = 60.0D;
